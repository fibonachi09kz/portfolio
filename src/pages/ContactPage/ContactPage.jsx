    ...
    return(
        <>
            ...
            <div className="max-w-7xl mx-auto px-6 my-10">
                <div className="relative border shadow rounded-lg">
                    <div className="grid grid-cols-1 lg:grid-cols-3">

                        <div className="relative overflow-hidden py-10 px-6 bg-gray-600 sm:px-10 xl:p-12 rounded-t-lg lg:rounded-none lg:rounded-l-lg">
